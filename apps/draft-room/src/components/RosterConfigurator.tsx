  ...
  return (
    <>
      <fieldset className="team-order-fieldset field-wide">
        ...
        <p className="team-order-note">Snake order is generated automatically from this order.</p>
      </fieldset>

      <fieldset className="roster-fieldset field-wide">
        <legend className="sr-only">Roster structure</legend>
        <div className="roster-heading">
          <div>
            <h3>Roster structure</h3>
            <p>Set starters and bench. Draft rounds update automatically.</p>
          </div>
          <button
        ...
        <div className={`roster-capacity ${isCapacityValid ? "" : "roster-capacity-invalid"}`}>
          ...
          <small>{isCapacityValid ? `${setup.teamCount * totalSlots} total selections.` : "Use between 8 and 24 total slots with at least one starter."}</small>
        </div>
      </fieldset>
    </>
  );
